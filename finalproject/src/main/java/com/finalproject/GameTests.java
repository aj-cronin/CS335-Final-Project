...
Tile t2 = new Tile(2);
Tile t4 = new Tile(4);
Theme theme = new Theme("light,d8c644,ff7575,FAF8F0,756452,FFFFFF");
	 ...
	 @Test
	  void testGetColor() {
	      assertEquals(t2.getColor(), theme.getColor(0));
	      assertEquals(t4.getColor(), theme.getColor(1));
	  }
	  ...
	  void testLeaderboardCreatePartiallyFull() {
	      assertEquals(lb.toString(), "1: nate - 3036");
	      }
